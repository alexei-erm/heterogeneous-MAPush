...
class Go1PushMidCfg(Go1Cfg):
    ...
    class asset(Go1Cfg.asset):
        ...
        npc_mass_override = 4.0  # Testing heavy box
        # target area
    ...
    class rewards(Go1Cfg.rewards):
        ...
        # HAPPO individualized rewards: if True, shared rewards (target, push, reach_target)
        # are weighted by agent proximity to box (contact-based credit assignment)
        # This prevents freeloading behavior where one agent does nothing while the other pushes
        ...
        class scales:
            ...
            # Iter4: Reduced from -0.0025 to -0.0008 so agents tolerate being near each other
            # Previously collision penalty dominated, causing agents to escape rather than push together
            collision_punishment_scale = -0.0008
